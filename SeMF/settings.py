...
#设置网站根地址
WEB_URL = 'http://192.168.0.186:8000'
...
EMAIL_HOST_USER = '2894701245@qq.com'    #我自己的邮箱
EMAIL_HOST_PASSWORD = 'gyfxnzvlrgasdecc' #'fzpyhddzinmadehb'         #我的邮箱密码
EMAIL_SUBJECT_PREFIX = u'[SeMF]'      #为邮件Subject-line前缀,默认是'[django]'
EMAIL_USE_TLS = True               #与SMTP服务器通信时，是否启动TLS链接(安全链接)。默认是false
#管理员站点
SERVER_EMAIL = '603381208@qq.com'
DEFAULT_FROM_EMAIL = '安全管控平台<2894701245@qq.com>'
